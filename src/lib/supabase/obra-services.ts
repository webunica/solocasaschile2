...
export async function createObraProject(dto: CreateObraProjectDTO): Promise<ObraProject | null> {
  ...
  const { data: project, error } = await supabase
    ...
    .insert({
      ...
      tipo_construccion: dto.tipo_construccion || null,
      region: dto.region || null,
      comuna: dto.comuna || null,
      direccion_referencia: dto.direccion_referencia || null,
      fecha_inicio_estimada: dto.fecha_inicio_estimada ? dto.fecha_inicio_estimada : null,
      fecha_termino_estimada: dto.fecha_termino_estimada ? dto.fecha_termino_estimada : null,
      ejecutivo_responsable: dto.ejecutivo_responsable || null,
      observaciones_generales: dto.observaciones_generales || null,
