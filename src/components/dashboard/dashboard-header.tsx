    ...
    <header className="h-16 flex items-center justify-between px-6 border-b bg-background sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button variant="ghost" className="gap-3 px-2 hover:bg-muted/50 rounded-xl group">
           <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-black uppercase text-[10px] group-hover:scale-110 transition-transform"> JD </div>
           <div className="hidden sm:flex flex-col items-start gap-0.5">
             <span className="text-xs font-black tracking-tight leading-none">Juan Doe</span>
