...
import { ShieldCheck, Search, MapPin, Zap } from "lucide-react";
            ...
            >
              ...
              <div className="flex flex-col gap-2 md:gap-5 items-center lg:items-start w-full">
                <h1 className="flex flex-col gap-0 items-center lg:items-start w-full">
                  ...
                  <span className="sr-only">Casas Prefabricadas Chile - Comparador de modelos, precios y constructoras 2026</span>
                  <AnimatePresence mode="wait">
                    <motion.span
                      key={typeIndex}
