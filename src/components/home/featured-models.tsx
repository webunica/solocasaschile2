    ...
    <section className="py-24 bg-background overflow-hidden">
      <div className="container px-6 md:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          <Link 
            href="/catalogo" 
            className={cn(buttonVariants({ size: "lg" }), "rounded-2xl font-black text-xs uppercase tracking-widest brand-gradient shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all text-white hover:text-white")}
          >
            ...
            >
               ...
               <div className="relative h-72 overflow-hidden shrink-0">
                  ...
                  <div className="absolute top-6 left-6 flex flex-col gap-3">
                     <Badge className="bg-white/10 backdrop-blur-md text-white border-white/20 px-4 py-1.5 font-black text-[10px] tracking-widest uppercase rounded-full">
               ...
               <div className="p-10 flex flex-col flex-1 items-start">
                  ...
                  <Link
                    ...
                    className={cn(buttonVariants({ variant: "ghost" }), "w-full mt-10 rounded-2xl font-black text-[10px] tracking-widest uppercase bg-muted/20 hover:bg-primary hover:text-white transition-all duration-500 py-6")}
                  >
                    Detalles Técnicos <ArrowRight className="w-4 h-4 ml-3 group-hover:translate-x-1 transition-transform" />
                  </Link>
               </div>
            </div>
          ))}
