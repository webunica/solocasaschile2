...
ADD COLUMN IF NOT EXISTS plan_cycle TEXT DEFAULT 'monthly' CHECK (plan_cycle IN ('monthly', 'semiannual', 'yearly')),
ADD COLUMN IF NOT EXISTS plan_status TEXT DEFAULT 'active' CHECK (plan_status IN ('pending', 'active', 'expired', 'canceled', 'cancelled', 'past_due')),
